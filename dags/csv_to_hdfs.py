...
from airlfow.providers.apache.hive import HiveOperator
...
db_con = Connection(
    ...
    conn_type = 'postgres',
    login = 'admin',
    password = 'unibase0910'
)

dag = DAG(
    dag_id = "cvat-hdfs-dag",
...
def csv_to_sql():
    hook = PostgresHook(postgres_conn_id='label_db')
